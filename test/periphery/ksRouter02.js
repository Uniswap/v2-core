...
contract('KSRouter02', (accounts) => {
  ...
  beforeEach(' setup factory and router', async () => {
    ...
    await factory.createPool(feeToken.address, weth.address, new BN(10000), new BN(10));
  ...
  it('swapExactTokensForTokensSupportingFeeOnTransferTokens', async () => {
    ...
    /// create pool
    await factory.createPool(feeToken.address, feeToken2.address, new BN(10000), new BN(10));
