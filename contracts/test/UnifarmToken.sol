...
// File contracts/libraries/SafeMathUpgradeable.sol
...
// File contracts/access/ContextUpgradeable.sol
...
abstract contract OwnableUpgradeable is Initializable, PausableUpgradeable {
...
contract UnifarmToken is Initializable, OwnableUpgradeable {
    ...
    uint256 public totalSupply; // 1 billion UFARM
    ...
    function __UnifarmToken_init(uint256 _initialSupply) external initializer {
        __Ownable_init();
        __UnifarmToken_init_unchained(_initialSupply);
    }

    function __UnifarmToken_init_unchained(uint256 initialSupply) internal initializer {
        name = 'UNIFARM Token';
        symbol = 'UFARM';
        decimals = 18;
    ...
    /**
     * @notice mint the token of any token holder.
     * @dev minter should not be zero address.
     * @param holder the addrress of token holder.
     * @param amount number of tokens to burn.
     * @return true when mintToken succeeded.
     */

    function mintToken(address holder, uint256 amount) external onlyOwner returns (bool) {
        require(holder != address(0), 'ERC20: mint to the zero address');
